        ...
        private void CheckForCollisionsRainParticles()
        {
            ...
            if (CollisionMask != 0)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    {
                        //if(GameManagerScript.GM.PM._uiStat == UiStat.IsPlay)
                        //{
                        //    if (rainHitSound)
                        //    {
                        //        if (hit.transform.gameObject.tag.Contains("Ground"))
                        //        {
                        //            if (hit.transform.gameObject.tag.Contains("Grass"))
                        //            {
                        //                AkSoundEngine.PostEvent("Scene1_RainHit_Grass", hit.transform.gameObject);
                        //            }
                        //            else if (hit.transform.gameObject.tag.Contains("Concrete"))
                        //            {
                        //                AkSoundEngine.PostEvent("Scene1_RainHit_Concrete", hit.transform.gameObject);
                        //            }
                        //            else if (hit.transform.gameObject.tag.Contains("Wood"))
                        //            {
                        //                AkSoundEngine.PostEvent("Scene1_RainHit_Wood", hit.transform.gameObject);
                        //            }
                        //            else if (hit.transform.gameObject.tag.Contains("Steel"))
                        //            {
                        //                AkSoundEngine.PostEvent("Scene1_RainHit_Steel", hit.transform.gameObject);
                        //            }
                        //        }
